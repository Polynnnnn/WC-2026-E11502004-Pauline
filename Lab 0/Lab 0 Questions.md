...
The website accessed is the French Wikipedia (fr.wikipedia.org), which can be seen in the TLS Client Hello packet (packet 21980).
...
## Identifying the Packets in the Capture
